...
//	SIEHE PACKAGE uebung3_boomerang
...
//    
//    //#Bumerang
//    RotKoerper throwOrigin;
//    double throw0PosX = 1.0f;
//    double throw0PosZ = 1.0f;
//    double throwPosX = throw0PosX;
//    double throwPosZ = throw0PosZ;
//    //Flugobjekt
//    Quader bumerang;
//    double foX = throwPosX;
//    double foZ = throwPosZ;
//    //Flugbahn
//    double w0 = (2 * Math.PI) / 4;	//w = 2*PI / T
//    double w = w0;
//    
//    
//    //  -------- Viewing-Volume  ---------------
...
//    //  ---------  Methoden  ----------------------------------
//
//    public Uebung3_Bumerang()                          // Konstruktor
//    { createFrame();
//    }
//
//
...
//       bumerang = new Quader(mygl);
//       throwOrigin = new RotKoerper(mygl);
//       
//       //#Kamerasystem
...
//      M = M.postMultiply(Mat4.translate((float) foX, 1.0f, (float) foZ));
//      mygl.setM(gl, M);
