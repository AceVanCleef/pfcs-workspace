package ch.fhnw.pfcs.opengl;//  -------------   Rotations-Koerper  (Kugel, Torus, Zylinder)  ------------
...
public class RotFactory {
    ...
    public RotFactory(MyVertexBuf vb) {
        this.vb = vb;
    }
     ...
     */
    private void calculatePoints(float[] x, float[] y, float[] nx, float[] ny, float[][] xa, float[][] ya, float[][] za,     // Gitternetz
     ...
     */
    public void drawRotationArea(GL3 gl, float[] x, float[] y, float[] nx, float[] ny, int n2) {
